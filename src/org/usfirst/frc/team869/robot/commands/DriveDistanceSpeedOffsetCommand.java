...
public class DriveDistanceSpeedOffsetCommand extends Command {
    
    private double inchesToTravel;
    private double leftSpeed,
    			   rightSpeed;

    public DriveDistanceSpeedOffsetCommand(double distanceInches, double leftSpeed, double rightSpeed) {
