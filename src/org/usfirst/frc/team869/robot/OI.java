...
public class OI {
    ...
    public OI(){
         ...
         */
         ...
         getButton(RobotMap.DRIVER_LEFT_CONTROLLER_ID, RobotMap.TOGGLE_CAMERA_BUTTON).whenReleased(new VisionToggleCommand());
         getButton(RobotMap.DRIVER_RIGHT_CONTROLLER_ID, RobotMap.TOGGLE_CAMERA_BUTTON).whenReleased(new VisionToggleCommand());
